        ...
        <div class="login-card">
            ...
            <form id="login_form" class="login100-form validate-form">
                ...
                <div class="form">
                    ...
                    <div id="container">
                        <h5><a class="txt2" href="/reset-page.php">Forgotten you password?</a></h5>
                    </div>
                </div>
            </form>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (res.success == 100) {
                        ...
                        showProgressBar(res.message);
                        setTimeout(function() {
                            location.href = '/cashier/home.php';
                        }, 5000);
                        ...
                        showProgressBar(res.message);
                        setTimeout(function() {
                            location.href = '/employee/home.php';
                        }, 5000);
                        ...
                        showProgressBar(res.message);
                        setTimeout(function() {
                            location.href = '/supplier/home.php';
                        }, 5000);
