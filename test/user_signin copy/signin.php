...
<body>
    ...
    <div class="login-wrap">
        ...
        <div class="login100-form-left-background">
                ...
                <div class="form">
                    ...
                    <div class="form-input">
                        <div class="d-flex justify-content-between align-items-center mx-20">
                                <a class="txt1" id="attemptCount" style="200px;"></a>
                                <a class="txt2" href="/reset-page.php">Forgot Password?</a>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (res.success == 100) {
                        ...
                        showProgressBar(res.message);
                        setTimeout(function() {
                            location.href = '/cashier/user_sale.php';
                        }, 5000);
