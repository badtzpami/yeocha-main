                        ...
                        <div class="table-responsive">
                            ...
                            <div class="row-materials">
                                <div class="material-cards">
                                    ...
                                    $first_material_list_query = "SELECT * FROM `material` WHERE type = 2 ORDER BY `ma_id` DESC LIMIT 1";
                                    ...
                                    <?php
                                    $material_list_query = "SELECT * FROM `material` WHERE `ma_id` != ' " . $first_material['ma_id'] . " ' AND type = 2 ORDER BY `ma_id` DESC";
