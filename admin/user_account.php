    ...
    <div class="page-header">
        <div class="page-header flex-wrap mt-3">
            <div class="row">
                <div class="col-9">
                    <div class="d-flex">
                        <h4 class="page-title pl-0 h5 pl-sm-2 text-muted d-inline-block">User Table</h4>
                    </div>
                </div>
                <div class="col-3">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        addBtn.addEventListener('click', function() {
            ...
            const roles = ['Choose Role', 'Admin', 'Cashier', 'Employee'];
            roles.forEach(role => {
    ...
    $(document).ready(function() {
        ...
        $(document).ready(function() {
            // Handle form submission for #updateUserActiveAccount
        ...
        $(document).ready(function() {
            $(document).on('submit', '#userPassword', function(e) {
                e.preventDefault();
                var formData = new FormData(this);
                formData.append("valid_password", true);
