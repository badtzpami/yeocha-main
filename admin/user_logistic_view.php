    ...
    <div class="page-header">
        <div class="page-header flex-wrap mt-3">
            <div class="row">
                <div class="col-9">
                    <div class="d-flex">
                        <h4 class="page-title pl-0 h5 pl-sm-2 text-muted d-inline-block">All Order</h4>
                    </div>
                </div>
                <div class="col-3">
    ...
    <section class="section">
        <div class="page-header flex-wrap">
            ...
            <div class="d-flex">
                ...
                ?>
                <a href="user_orders_view.php?order=<?= $fetch_order['or_id'] ?>" style="text-decoration:none;">
            ...
            <col-lg-12>
                <div class="table-responsive">
                    ...
                    <form id="CancelItem" method="post"> <!-- Button or Card that will trigger the URL change -->
                        ...
                        <?php include_once '../user_data/all_logistic_view.php'; ?>
