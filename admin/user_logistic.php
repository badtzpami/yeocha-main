    ...
    <div class="page-header">
        <div class="page-header flex-wrap mt-3">
            <div class="row">
                <div class="col-9">
                    <div class="d-flex">
                        <h4 class="page-title pl-0 h5 pl-sm-2 text-muted d-inline-block">All Order Updates</h4>
                    </div>
                </div>
                <div class="col-3">
                    ...
                    <div class="d-flex">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">User Logistics</li>
                            </ol>
                        </nav>
                    </div>
            ...
            <div class="d-flex">
                <a href="../admin/user_category.php">
                    <button type="button" class="btn">
                        <i class="bi bi-refresh btn-icon-prepend"></i>Back
                    </button>
                </a>
        ...
        <div class="row">
            <col-lg-12>
                <div class="table-responsive">
                    <h5 class="card-title">View All Order Logistics</h5>
                    <form id="CancelItem" method="post"> <!-- Button or Card that will trigger the URL change -->

                        <!-- Content that will change dynamically -->
                        <?php include_once '../user_data/all_logistic.php'; ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('submit', '#CancelItem', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (res.success == 100) {
                        ...
                        setTimeout(function() {
                            location.href = '/admin/user_orders.php';
                        }, 6000);
    ...
    $(document).ready(function() {
        // Handle form submission for #updateUserCategory
        $(document).on('submit', '#BuyAgainItem', function(e) {
            e.preventDefault();
...
<script>
    function copyOrderCode() {
        ...
        showMessageBox('Successfully Copy!', 'Order code copied to clipboard!', 'success');
