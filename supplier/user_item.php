                ...
                <div class="card stretch-card" id="activeMaterialContent" style="display: none;">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <?php include_once '../user_data/supplier_history_data.php'; ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <form id="updateUserArchive" method="post">
                                ...
                                <?php include_once '../user_data/supplier_archive_data.php'; ?>
    ...
    `;
        ...
        $(document).ready(function() {
            ...
            $(document).on('submit', '#addUserMaterial', function(e) {
                ...
                formData.append("valid_material_supplier", true);
        ...
        $(document).ready(function() {
            // Handle form submission for #updateUserMaterial
            $(document).on('submit', '#updateUserMaterial', function(e) {
                e.preventDefault(); // Prevent the default form submission

                // Create a new FormData object
                var formData = new FormData(this);
                formData.append("update_material_supplier", true); // Ensure this is sent to identify the request

                // Send the AJAX request
                $.ajax({
                    type: "POST",
                    url: "../user_process/user_delivery_process.php", // The PHP file handling the request
                    data: formData,
                    contentType: false, // Don't set contentType for FormData
                    processData: false, // Don't process data as string (important for files)
                    success: function(response) {
                        console.log('Server response:', response);

                        var res = jQuery.parseJSON(response); // Parse the response

                        // Check the success code and handle the response
                        if (res.success == 100) {
                            showMessageBox(res.title, res.message, 'success');
                            setTimeout(function() {
        ...
        $(document).ready(function() {
            ...
            $(document).on('submit', '#updateUserArchive', function(e) {
                ...
                // Create a new FormData object
                var formData = new FormData(this);
                formData.append("update_material_supplier", true);
