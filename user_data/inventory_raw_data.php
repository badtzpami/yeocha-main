...
<table class="table table-hover" id="table_inventory_raw">
    <thead>
        <tr>
            <th>#</th>
            <th>Image</th>
        ...
        if (mysqli_num_rows($material_list_result) > 0) {
            while ($material = mysqli_fetch_array($material_list_result)) { ?>
                ...
                <tr>
                    ...
                    <!-- <td style="width: 200px;"><input type="text" name="stock[]" class="form-control" value="<?php echo $material["enter_stock"] ?>"></td> -->


                    <td style="width: 200px;">
                        <?php if ($material["unit"] != 3) { ?>
                            <select name="enter_stock[]" id="unit_name">
                                <option value="" disabled <?php echo 0 ? 'selected' : ''; ?>>Choose Category</option>
                                <option value="AVAILABLE" <?php echo $material["remarks"] == "AVAILABLE" ? 'selected' : ''; ?>>AVAILABLE</option>
                                <option value="UNAVAILABLE" <?php echo $material["remarks"] == "UNAVAILABLE" ? 'selected' : ''; ?>>UNAVAILABLE</option>
                            </select>
                        <?php } else { ?>
                            <input type="text" name="enter_stock[]" class="form-control" value="<?php echo $material["enter_stock"] ?>">
                        <?php } ?>
                    </td>

                    <td style="width: 200px;">
                        <input type="text" name="comment[]" class="form-control" value="<?php echo $material["comment"] ?>">
                    </td>

                    <td>
                        <h6 class="counter" style="width: 200px">
                            <?php echo $material["remarks"] ?><input type="hidden" name="remark[]" class="form-control" value="<?php echo $material["remarks"] ?>">
                        </h6>
                    </td>
