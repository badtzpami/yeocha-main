...
LEFT JOIN
 ...
 WHERE $u_id o.status = 'At Your Shop'  AND u.store != '' GROUP BY o.order_code ORDER BY order_date_created_at DESC";
                ...
                <div class="card card-custom"  style=" height: 355px !important;">
                    ...
                    <div class="row mb-3">
                        <div class="col-12 text-end">
                            ...
                            <?php
                            if (isset($_SESSION["user_id_admin"])) { ?>
                                <button class="buy-again-btn update_order button3" data-bs-toggle="modal" data-bs-target="#changePassword" value="<?= $material['or_id']; ?>" data-role="change_password" id="<?php echo $material['or_id']; ?>">Received</button>
