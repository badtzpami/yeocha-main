...
LEFT JOIN
 ...
 WHERE $u_id o.status = 'To Pack'  AND u.store != '' GROUP BY o.order_code ORDER BY order_date_created_at DESC";
                    ...
                    <div class="row mb-3">
                        <div class="col-12 text-end">
                            ...
                            <?php } else if (isset($_SESSION["user_id_supplier"])) { ?>
                                <button class="buy-again-btn update_order button3" data-bs-toggle="modal" data-bs-target="#changePassword" value="<?= $material['or_id']; ?>" data-role="change_password" id="<?php echo $material['or_id']; ?>">Proceed to Ship</button>
                                <?php } else {
                            }
                            ?>
