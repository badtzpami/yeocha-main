        ...
        if (mysqli_num_rows($material_list_result) > 0) {
            while ($material = mysqli_fetch_array($material_list_result)) { ?>
                ...
                <tr>
                            ...
                            <form class="form" id="formmaterial<?php echo $material["ma_id"] ?>">
                                <div class="upload" style=" width: 125px;
                                    ...
                                    <div class="round1" style="position: absolute;
                                        ...
                                        text-align: top;
                                        overflow: hidden;">
                                        <button type="button" class="btn" data-toggle="modal" data-target="#exampleArchiveModal<?php echo $material["ma_id"] ?>" style="top:0; background: transparent; border:0;width: 42px; height: 42px;"><i class="bi bi-arrows-angle-expand" style="color: #000; font-size: 20px; border:0; background: #fff;"></i></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <td style="width: 200px;"><input type="text" name="stock[]" class="form-control" value="<?php echo $material["stock"] ?>"></td>
                    <td>
                ...
                <!-- Modal -->
                <div class="modal fade pb-5" id="exampleArchiveModal<?php echo $material["ma_id"] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleArchiveModalLabel" aria-hidden="true" style="background-color: rgba(0,0,0,0.7);">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header" style=" font-size: 14px; font-weight: 800; background: #535e70; color: #fff; text-align: center; border-bottom: 2px solid #ebedf2;">
                                <h5 class="modal-title" id="exampleArchiveModalLabel" style="color: #fff;">View Material Image</h5>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <h6><strong>Amount:</strong> <span><?= $material['stock']  ?> <?php if ($material['unit'] == 1) {
                                                                                                            echo 'ML';
                                                                                                        } else if ($material['unit'] == 2) {
                                                                                                            echo 'G';
                                                                                                        } else {
