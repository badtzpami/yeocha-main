...
if (isset($_SESSION['checkUser']) || !isset($_SESSION['send_email']) || !isset($_SESSION['verify_email']) || !isset($_SESSION['verify_code']) || !isset($_SESSION['resend_email']) || !isset($_SESSION['resend_code'])) {
    header("Location: ../user_signin/reset-page.php");
    session_destroy();
} else
...
<body>
    ...
    <div class="login-wrap">
        ...
        <div class="login-card">
            ...
            <!-- Reset Password Form -->
            <form id="reset_password_form" class="login100-form validate-form">
                ...
                <div class="form">
                    ...
                    <div class="form-input">
                        <i id="account" class="mdi mdi-lock menu-icon"></i>
                        <input type="password" id="newpass" name="newpass" class="newpass" placeholder="New Password">
                        <i id="toggler1" class="far fa-eye"></i>
                    </div>
                    <div class="form-input">
                        <i id="lock" class="mdi mdi-lock menu-icon"></i>
                        <input type="password" id="verifypass" name="verifypass" class="verifypass" placeholder="Confirm your password">
                        <i id="toggler2" class="far fa-eye"></i>
                    </div>

                    <input type="hidden" id="email" name="email" value="<?php echo $_SESSION['verify_email']; ?>">

                    <div class="form-input">
                        <button type="submit" class="login100-form-btn button">
                            Change Password
                        </button>
                        <a class="back_login" href="/yeocha_main/user_signin/signin.php">Back to Log in</a>
            ...
            <!-- <h5><a class="txt2" href="/yeocha_main/user_signin/signin.php"> Back to Login</a></h5> -->
    ...
    <script>
        ...
        // Toggle password visibility
        var verifypassword = document.getElementById('verifypass');
        var toggler2 = document.getElementById('toggler2');

        showHideVerifyPassword = () => {
            if (verifypassword.type == 'password') {
                verifypassword.setAttribute('type', 'text');
                toggler2.classList.add('fa-eye-slash');
            } else {
                toggler2.classList.remove('fa-eye-slash');
                verifypassword.setAttribute('type', 'password');
            }
        };

        toggler1.addEventListener('click', showHideNewPassword);
        toggler2.addEventListener('click', showHideVerifyPassword);
        ...
        $(document).ready(function() {
            ...
            $('#reset_password_form').on('submit', function(e) {
                ...
                const verifypass = $('#verifypass').val();
                const email = $('#email').val();
                const reset_password_form = $('#reset_password_form').val();
