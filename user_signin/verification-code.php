                ...
                <div class="row" id="bottom-row">
                    <form id="resend_code_form">
                        ...
                        <input type="hidden" id="rc_email" name="rc_email" value="<?php echo $_SESSION['send_email']; ?>">
                            <button type="submit" class="btn-resend txt2">
                                Send new Code
                            </button>
                ...
                $.ajax({
                    ...
                    success: function(response1) {
                        ...
                        if (res1.success == 100) {
                            ...
                            setTimeout(function() {
                                location.href = '/yeocha_main/user_signin/resetpassword.php';
                            }, 3000);
                ...
                $.ajax({
                    ...
                    success: function(response2) {
                        ...
                        if (res2.success == 100) {
                            ...
                            setTimeout(function() {
                                location.href = '/yeocha_main/user_signin/verification-code.php';
                            }, 3000);
